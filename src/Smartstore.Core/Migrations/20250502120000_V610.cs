...
namespace Smartstore.Core.Data.Migrations
{
    ...
    internal class V610 : Migration, ILocaleResourcesProvider, IDataSeeder<SmartDbContext>
    {
        ...
        {
            builder.AddOrUpdate(
                "Admin.Configuration.Settings.Search.CommonFacet.Sorting",
                "Sorting",
                "Sortierung",
            ...
            builder.AddOrUpdate(
                "Enums.FacetSorting.ValueAsc",
                "Value/ID: lowest first",
                "Wert/ID: Niedrigste zuerst"
            );

            builder.AddOrUpdate(
                "Admin.Common.ExportToPdf.TooManyItems",
            ...
            builder.AddOrUpdate(
                "Admin.Configuration.Settings.GeneralCommon.MaxItemsToPrint",
            ...
            builder.AddOrUpdate(
                "Admin.Configuration.Settings.Shipping.CalculateShippingAtCheckout",
            ...
            builder.AddOrUpdate(
                "Admin.Configuration.Settings.Shipping.UseShippingOriginIfShippingAddressMissing",
            ...
            builder.AddOrUpdate(
                "Admin.Configuration.Settings.RewardPoints.RoundDownPointsForPurchasedAmount",
            ...
            builder.AddOrUpdate(
                "Admin.Configuration.Settings.CustomerUser.HideMyAccountOrders",
                "Hide orders in the \"My account\" area",
                "Bestellungen im Bereich \"Mein Konto\" ausblenden"
            );

            builder.AddOrUpdate(
                "Admin.Rules.FilterDescriptor.VariantInCart",
                "Product with SKU in cart",
                "Produkt mit SKU im Warenkorb"
            );

            builder.AddOrUpdate("Admin.RecurringPayments.History").Value("de", "Historie");
            builder
                .AddOrUpdate("Admin.RecurringPayments.Fields.CyclesRemaining")
                .Value("de", "Verbleibende Zahlungen");
            builder
                .AddOrUpdate("Admin.RecurringPayments.Fields.CyclesRemaining.Hint")
                .Value("de", "Die Anzahl der verbleibenden Zahlungen");

            builder.AddOrUpdate(
                "Admin.RecurringPayments.List.RemainingCycles",
                "Remaining payments",
            ...
            builder.AddOrUpdate(
                "Account.CustomerOrders.RecurringOrders.Cancel",
                "Cancel repeat delivery",
                "Regelmäßige Lieferung abbrechen"
            );
            builder.AddOrUpdate(
                "Account.CustomerOrders.RecurringOrders",
                "Repeat deliveries",
                "Regelmäßige Lieferungen"
            );
            builder.AddOrUpdate(
                "Account.CustomerOrders.RecurringOrders.TotalCycles",
                "Total deliveries",
            ...
            builder.AddOrUpdate(
                "Account.CustomerOrders.RecurringOrders.CancelDelivery",
                "Would you like to cancel the repeat delivery?",
                "Möchten Sie die regelmäßige Lieferung abbrechen?"
            );

            builder.AddOrUpdate(
                "Account.CustomerOrders.RecurringOrders.SuccessfullyCanceled",
            ...
            builder.AddOrUpdate(
                "Admin.Catalog.Products.RecycleBin.DeleteProductsResult",
                "{0} of {1} products have been permanently deleted.",
                "Es wurden {0} von {1} Produkten endgültig gelöscht."
            );

            builder.AddOrUpdate(
                "Admin.Catalog.Products.RecycleBin.DeletedAndSkippedProductsResult",
            ...
            builder.AddOrUpdate(
                "Order.CannotCompleteUnpaidOrder",
            ...
            builder.AddOrUpdate(
                $"{prefix}.AlwaysPrefetchTranslations",
            ...
            builder.AddOrUpdate(
                $"{prefix}.MaxUnavailableAttributeCombinations",
            ...
            builder.AddOrUpdate(
                $"{prefix}.MediaDupeDetectorMaxCacheSize",
...
auch wenn die typspezifischen Limits nicht erreicht wurden. Ein leerer Wert bedeutet: keine Begrenzung."
            ...
            builder.AddOrUpdate(
                $"{prefix}.EnableOverloadProtection",
            ...
            builder.AddOrUpdate(
                $"{prefix}.ForbidNewGuestsIfSubRequest",
...
Wenn diese Option aktiviert ist, werden neue Gäste unter diesen Umständen blockiert."
            ...
            builder.AddOrUpdate(
                "Smartstore.AI.Prompts.PleaseContinue",
            ...
            builder.AddOrUpdate(
                "Smartstore.AI.Prompts.ContinueHere",
                "[Continue here]",
                "[Fortsetzung hier]"
            );

            builder.AddOrUpdate(
                "Smartstore.AI.Prompts.Suggestions.Separation",
                "Separate the suggestions with the ¶ character (paragraph mark).",
                "Trenne die Vorschläge durch das ¶ Zeichen (Absatzmarke)."
            );

            builder.AddOrUpdate(
                "Smartstore.AI.Prompts.Suggestions.NoNumbering",
                "Do not use numbering.",
                "Verwende keine Nummerierungen."
            );

            builder.AddOrUpdate(
                "Smartstore.AI.Prompts.Suggestions.NoRepitions",
            ...
            builder.AddOrUpdate(
                "Smartstore.AI.Prompts.DontUseQuotes",
            ...
            builder.AddOrUpdate(
                "Admin.Orders.CompleteUnpaidOrder",
            ...
            builder.AddOrUpdate("Products.Sorting.Featured").Value("en", "Recommendation");

            builder.AddOrUpdate(
                "Admin.Configuration.Settings.Search.UseFeaturedSorting",
            ...
            builder.AddOrUpdate(
                "Admin.Catalog.Products.Fields.DisplayOrder",
                "Display order",
                "Reihenfolge",
            ...
            builder.AddOrUpdate(
                "Admin.Configuration.Settings.Shipping.FreeShippingCountryIds",
            ...
            builder.AddOrUpdate(
                "Smartstore.AI.Prompts.Role.Rules",
                "You must strictly follow these rules:",
                "Diese Regeln sind zwingend einzuhalten:"
            );

            builder.AddOrUpdate(
                "Smartstore.AI.Prompts.Role.HtmlEditor",
            ...
            builder.AddOrUpdate(
                "Smartstore.AI.Prompts.CreateHtml",
                "Return only pure HTML code",
                "Gib ausschließlich reinen HTML-Code zurück"
            );

            builder.AddOrUpdate(
                "Smartstore.AI.Prompts.DontUseMarkdown",
            ...
            builder.AddOrUpdate(
                "Smartstore.AI.Prompts.CaretPos",
            ...
            builder.AddOrUpdate(
                "Smartstore.AI.Prompts.ReturnNewTextOnly",
            ...
            builder.AddOrUpdate(
                "Smartstore.AI.Prompts.WrapNewContentWithHighlightTag",
            ...
            builder.AddOrUpdate(
                "Smartstore.AI.Prompts.MissingCaretPosHandling",
            ...
            builder.AddOrUpdate(
                "Smartstore.AI.Prompts.ValidHtmlOutput",
            ...
            builder.AddOrUpdate(
                "Smartstore.AI.Prompts.ContinueAtPlaceholder",
            ...
            builder.AddOrUpdate(
                "Smartstore.AI.Prompts.RemoveCaretPosPlaceholder",
            ...
            builder.AddOrUpdate(
                "Smartstore.AI.Prompts.ReturnCompleteParentTag",
            ...
            builder.AddOrUpdate(
                "Smartstore.AI.Prompts.ReturnCompleteTable",
            ...
            builder.AddOrUpdate(
                "Smartstore.AI.Prompts.ReturnCompleteList",
            ...
            builder.AddOrUpdate(
                "Smartstore.AI.Prompts.ReturnCompleteDefinitionList",
            ...
            builder.AddOrUpdate(
                "Smartstore.AI.Prompts.ReturnInstructionReinforcer",
            ...
            builder.AddOrUpdate(
                "Smartstore.AI.Prompts.PreservePreviousHighlightTags",
            ...
            builder.AddOrUpdate(
                "Smartstore.AI.Prompts.ContinueTable",
            ...
            builder.AddOrUpdate(
                "Admin.Catalog.Products.List.SearchWithOrders",
            ...
            builder.AddOrUpdate(
                "Admin.Customers.CookieConsent",
                "Cookie consent",
                "Cookie-Zustimmung"
            );

            builder.AddOrUpdate(
                "Admin.Customers.CookieConsent.ConsentOn",
                "Cookie consent on",
            ...
            builder.AddOrUpdate(
                "Smartstore.AI.Prompts.NoFriendlyIntroductions",
            ...
            builder.AddOrUpdate(
                "Smartstore.AI.Prompts.StartWithDivTag",
            ...
            builder.AddOrUpdate(
                "Smartstore.AI.Prompts.UseImagePlaceholders",
            ...
            builder.AddOrUpdate(
                "Smartstore.AI.Prompts.Role.ProductExpert",
                "Be an expert for the product: '{0}'.",
                "Du bist ein Experte für das Produkt: '{0}'."
            );
            builder.AddOrUpdate(
                "Smartstore.AI.Prompts.Role.ImageAnalyzer",
            ...
            builder.AddOrUpdate(
                "Admin.Configuration.Settings.GeneralCommon.AddAlternateHtmlLinks",
                "Add alternate links for localized pages",
                "Alternate Links für lokalisierte Seiten hinzufügen",
            ...
            builder.AddOrUpdate(
                "Smartstore.AI.Prompts.ImageAnalyzer.ObjectDefinition",
            ...
            builder.AddOrUpdate(
                "Smartstore.AI.Prompts.ImageAnalyzer.ObjectDefinition.Title",
            ...
            builder.AddOrUpdate(
                "Smartstore.AI.Prompts.ImageAnalyzer.ObjectDefinition.Alt",
            ...
            builder.AddOrUpdate(
                "Smartstore.AI.Prompts.ImageAnalyzer.ObjectDefinition.Tags",
            ...
            builder.AddOrUpdate(
                "Smartstore.AI.Prompts.ImageAnalyzer.NoContent",
            ...
            builder.AddOrUpdate(
                "Smartstore.AI.Prompts.CreateJson",
            ...
            builder.AddOrUpdate(
                "Smartstore.AI.Prompts.Translator.TranslateTextContentOnly",
            ...
            builder.AddOrUpdate(
                "Smartstore.AI.Prompts.Translator.PreserveHtmlStructure",
            ...
            builder.AddOrUpdate(
                "Smartstore.AI.Prompts.Translator.IgnoreTechnicalAttributes",
            ...
            builder.AddOrUpdate(
                "Smartstore.AI.Prompts.Translator.KeepHtmlEntitiesIntact",
            ...
            builder.AddOrUpdate(
                "Smartstore.AI.Prompts.Translator.TranslateWithContext",
            ...
            builder.AddOrUpdate(
                "Smartstore.AI.Prompts.Translator.TranslateDescriptiveAttributes",
            ...
            builder.AddOrUpdate(
                "Smartstore.AI.Prompts.Translator.PreserveToneAndStyle",
            ...
            builder.AddOrUpdate(
                "Smartstore.AI.Prompts.Translator.SkipAlreadyTranslated",
                "If the text is already in the target language, return it unchanged.",
                "Wenn der Text bereits in der Zielsprache vorliegt, gib ihn unverändert zurück."
            );

            builder.AddOrUpdate(
                "Smartstore.AI.Prompts.Translator.NoMetaComments",
            ...
            builder.AddOrUpdate(
                "Smartstore.AI.Prompts.Product.NoAssumptions",
            ...
            builder.AddOrUpdate(
                "Smartstore.AI.Prompts.OneParagraph",
            ...
            builder.AddOrUpdate(
                "Admin.Customers.DeleteCustomer",
                "Delete customer",
                "Kunde löschen"
            );
            ...
            builder.AddOrUpdate(
                "Admin.DataExchange.Import.UpdateAllKeyFieldMatches",
            ...
            // Fix:
            builder
                .AddOrUpdate("Admin.DataExchange.Import.KeyFieldNames.Note")
                .Value(
                    "de",
                    "Bitte verwenden Sie das Feld ID nur dann als Schlüsselfeld, wenn die Daten aus derselben Datenbank stammen, in die sie importiert werden sollen. Andernfalls können falsche Datensätze aktualisiert werden."
                );

            builder.AddOrUpdate(
                "Smartstore.AI.Prompts.ReserveSpaceForShopName",
