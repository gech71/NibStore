    ...
    public class CheckoutFactory : ICheckoutFactory
    {
            ...
            ShoppingCartSettings shoppingCartSettings)
        {
            ...
            else if (shoppingCartSettings.CheckoutProcess.EqualsNoCase(CheckoutProcess.TerminalWithPayment))
            {
                ...
                _handlers = handlers
                    .Where(x => x.Metadata.HandlerType.Equals(typeof(ConfirmHandler)) || x.Metadata.HandlerType.Equals(typeof(PaymentMethodHandler)) || x.Metadata.HandlerType.Equals(typeof(ShippingMethodHandler)))
                    .OrderBy(x => x.Metadata.Order);
            }
            else
            {
